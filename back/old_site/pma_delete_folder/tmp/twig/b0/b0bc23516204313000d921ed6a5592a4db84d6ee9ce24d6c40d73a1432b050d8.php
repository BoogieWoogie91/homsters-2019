...
/* select_lang.twig */
class __TwigTemplate_2327f5d14d6a97d0d4a5876bb42d9e4be005b1290b6ca730df49f334ad23a0e3 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            // line 17
            echo "        <option value=\"";
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, twig_template_get_attributes($this, $context["language"], "getCode", array(), "method")), "html", null, true);
            echo "\"";
            // line 18
            if (twig_template_get_attributes($this, $context["language"], "isActive", array(), "method")) {
                // line 19
        ...
        ";
            // line 22
            echo twig_template_get_attributes($this, $context["language"], "getName", array(), "method");
            echo "
        </option>
    ";
        }
...
";
    ...
    {
        return new Twig_Source("", "select_lang.twig", "/var/www/html/expo.homsters.kz/phpMyAdmin-4.8.3-all-languages/templates/select_lang.twig");
    }
}
