...
class __TwigTemplate_e19997054ee8a8ab4f8bdcc574e73436e43952c9b9cdbd68a1a9f658958ba22c extends Twig_Template
{
...
(isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context))) ? (array(0 => "button bookmarks", 1 => _gettext("Bookmarks"))) : (null)), 5 => array(0 => "button debug hide", 1 => _gettext("Debug SQL")))));
        ...
        if ( !twig_test_empty((isset($context["sql_history"]) ? $context["sql_history"] : null))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
                ...
                // line 29
                echo ((preg_match("@^SELECT[[:space:]]+@i", twig_template_get_attributes($this, $context["record"], "sqlquery", array(), "array"))) ? (" select") : (""));
                echo "\"
                            targetdb=\"";
                // line 30
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["record"], "db", array(), "array"), "html", null, true);
                echo "\" targettable=\"";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["record"], "table", array(), "array"), "html", null, true);
                echo "\">
                            ";
                // line 31
...
(isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context))) ? (array(0 => "action bookmark", 1 => _gettext("Bookmark"))) : (null)), 7 => array(0 => "text failed", 1 => _gettext("Query failed")), 8 => array(0 => "text targetdb", 1 => _gettext("Database"), "extraSpan" => twig_template_get_attributes($this,                 // line 42
$context["record"], "db", array(), "array")), 9 => array(0 => "text query_time", 1 => _gettext("Queried time"), "extraSpan" => ((twig_template_get_attributes($this,                 // line 46
$context["record"], "timevalue", array(), "array", true, true)) ? (twig_template_get_attributes($this,                 // line 47
$context["record"], "timevalue", array(), "array")) : (_gettext("During current session")))))));
                // line 51
                echo "                            <span class=\"query\">";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["record"], "sqlquery", array(), "array"), "html", null, true);
                echo "</span>
                        </div>
                    ";
            }
...
";
    ...
    {
        return new Twig_Source("", "console/display.twig", "/var/www/html/expo.homsters.kz/phpMyAdmin-4.8.3-all-languages/templates/console/display.twig");
    }
}
